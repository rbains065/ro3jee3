      ...
      <section className="section-y bg-white scroll-mt-28" id="websites">
        <div className="container-page">
          ...
          <motion.div 
            ...
            className="mx-auto mt-10 max-w-3xl rounded-2xl border-2 border-accent/40 bg-accent/5 p-6"
          >
        ...
        <div className="container-page">
          ...
          <div className="mx-auto max-w-3xl space-y-4">
            {[
              ...
              >
                <div className="text-xs font-bold uppercase tracking-wider text-accent">{item.tier}</div>
      ...
      <section className="section-y bg-surface">
        <div className="container-page">
          <motion.div 
            ...
            className="mx-auto max-w-2xl text-center mb-10"
          >
            <h2 className="h2 text-primary">Buildora vs. Typical Agency</h2>
      ...
      <section className="section-y bg-surface">
        <div className="container-page">
          <motion.div 
            ...
            viewport={{ once: true, margin: "-100px" }}
            transition={{ duration: 0.7, ease: [0.16, 1, 0.3, 1] }}
            className="mx-auto max-w-3xl rounded-3xl bg-gradient-to-br from-primary to-[oklch(0.32_0.06_252)] p-8 text-center text-white shadow-lg md:p-12"
          >
      ...
      <section className="section-y bg-white">
        <div className="container-page">
          <motion.div 
            ...
            viewport={{ once: true, margin: "-100px" }}
            transition={{ duration: 0.6, ease: [0.16, 1, 0.3, 1] }}
            className="mx-auto max-w-3xl rounded-2xl border-2 border-accent/30 bg-accent/5 p-8 md:p-10"
          >
