        ...
        <div className="container-page">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              return (
                <div key={idx} className="rounded-2xl border border-border bg-card p-6 shadow-sm hover:border-accent transition-colors">
        ...
        <div className="container-page text-center">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 max-w-5xl mx-auto">
            {[
              ...
              <div key={i} className="rounded-xl border border-border overflow-hidden bg-card text-left shadow-sm">
